...
class EltdSliderShortcode {
    ...
    public function render($atts, $content = null) {
        ...
        if ($slider != "") {
            ...
            if ($slider_parallax == 'no' || (borderland_elated_options()->getOptionValue( 'paspartu' ) == 'yes' && ((borderland_elated_options()->getOptionValue( 'paspartu_on_top' ) == 'yes') || (borderland_elated_options()->getOptionValue( 'paspartu_on_bottom_slider' ) == 'yes')))) {
            ...
            if (isset($slider_meta['slider_thumbs'])) {
                if(borderland_elated_options()->getOptionValue( 'vertical_area' ) =='no' && borderland_elated_options()->getOptionValue( 'paspartu' ) == 'no') {
            ...
            if (borderland_elated_options()->getOptionValue( 'header_background_transparency_initial' ) != "1" && borderland_elated_options()->getOptionValue( 'header_background_transparency_initial' ) != "") {
            ...
            if (borderland_elated_options()->getOptionValue( 'navigation_button_height' ) != '') {
                $arrow_button_height = esc_attr(borderland_elated_options()->getOptionValue( 'navigation_button_height' ));
            }
            ...
            if (borderland_elated_options()->getOptionValue( 'enable_manu_item_border' ) == 'yes' && borderland_elated_options()->getOptionValue( 'menu_item_style' ) == 'large_item') {
                if (borderland_elated_options()->getOptionValue( 'menu_item_border_style' ) == 'all_borders') {
                    $large_menu_item_border = esc_attr(borderland_elated_options()->getOptionValue( 'menu_item_border_width' )) * 2;
                }
                if (borderland_elated_options()->getOptionValue( 'menu_item_border_style' ) == 'top_bottom_borders') {
                    $large_menu_item_border = esc_attr(borderland_elated_options()->getOptionValue( 'menu_item_border_width' )) * 2;
                }
                if (borderland_elated_options()->getOptionValue( 'menu_item_border_style' ) == 'bottom_border') {
                    $large_menu_item_border = esc_attr(borderland_elated_options()->getOptionValue( 'menu_item_border_width' ));
                }
            }
            ...
            if (borderland_elated_options()->getOptionValue( 'header_bottom_appearance' )) {
                switch (borderland_elated_options()->getOptionValue( 'header_bottom_appearance' )) {
                    case 'stick':
                        $logo_height = esc_attr(borderland_elated_options()->getOptionValue( 'logo_height' )) / 2;
                        break;
                    ...
                    case 'fixed_hiding':
                        ...
                        break;
                    default:
                        $logo_height = esc_attr(borderland_elated_options()->getOptionValue( 'logo_height' ));
                        break;
                }
            }
            ...
            if ((get_post_meta($page_id, "eltd_header_color_transparency_per_page", true) !== "0") && (borderland_elated_options()->getOptionValue( 'header_background_transparency_initial' ) !== "0") && ((borderland_elated_options()->getOptionValue( 'paspartu' ) == 'no') || (borderland_elated_options()->getOptionValue( 'paspartu_on_top' ) == 'no')) && !$hide_sticky_header) {

                $header_height_padding = $header_height + $menu_bottom + $header_top;
                if ((borderland_elated_options()->getOptionValue( 'center_logo_image' ) == "yes" && borderland_elated_options()->getOptionValue( 'header_bottom_appearance' ) !== 'stick menu_bottom' && borderland_elated_options()->getOptionValue( 'header_bottom_appearance' ) !== 'stick_with_left_right_menu') || borderland_elated_options()->getOptionValue( 'header_bottom_appearance' ) == "fixed_hiding") {
            ...
            $custom_cursor = "";
            if(borderland_elated_options()->getOptionValue( 'qs_enable_navigation_custom_cursor' ) =="yes"){
                $custom_cursor = "has_custom_cursor";
            }

            if((borderland_elated_options()->getOptionValue( 'paspartu' ) == 'yes' && ((borderland_elated_options()->getOptionValue( 'paspartu_on_top' ) == 'yes') || (borderland_elated_options()->getOptionValue( 'paspartu_on_bottom_slider' ) == 'yes'))) || $slider_parallax == "no"){
            ...
            if(borderland_elated_options()->getOptionValue( 'loading_animation' ) == "on") {
                if(borderland_elated_options()->getOptionValue( 'loading_image' ) != "") {
                    $ajax_loader = '<div class="ajax_loader" ' . $loader_margin_top . '><div class="ajax_loader_1"><div class="ajax_loader_2"><img src="' . esc_url(borderland_elated_options()->getOptionValue( 'loading_image' )) . '" alt="" /></div></div></div>';
                }else{
                    $ajax_loader = '<div class="ajax_loader" ' . $loader_margin_top . '><div class="ajax_loader_1">' . borderland_elated_loading_spinners(true) . '</div></div>';
                }
            }

            $html .= '<div id="eltd-' . esc_attr($slider) . '" ' . $anchor_data . ' ' . $responsiveness_data . ' ' . $responsive_coefficients_graphic_data . ' ' . $responsive_coefficients_title_data . ' ' . $responsive_coefficients_subtitle_data . ' ' . $responsive_coefficients_text_data . ' ' . $responsive_coefficients_button_data . ' class="carousel slide ' . esc_attr($animation_type_class . ' ' . $custom_cursor . ' ' . $full_screen_class . ' ' . $responsive_height_class . ' ' . $height_class . ' ' . $auto_start_class . ' ' . $header_effect_class . ' ' . $slider_numbers_class .  ' ' . $slider_thumbs_class . ' ' . $slider_transparency_class . ' ' . $navigation_position_class . ' ' . $content_next_to_arrows_class) . '" ' . $slide_animation . ' ' . $data_height . ' ' . $data_parallax_effect . ' '.borderland_elated_get_inline_style($slide_holder_height. $background_color).'><div class="eltd_slider_preloader" '.borderland_elated_get_inline_style($background_color).'>'.$ajax_loader.'</div>';
            $html .= '<div class="carousel-inner ' . esc_attr($slider_css_position_class) . '" '.borderland_elated_get_inline_style($carouselinner_height).' '.$data_parallax_transform.'>';
	        
            $query_loop = new WP_Query( $query_args );
	
	        $found_slides =  $query_loop->post_count;
	        ...
	        if ( $query_loop->have_posts() ):
		        ...
		        while ( $query_loop->have_posts() ) : $query_loop->the_post();
                    ...
                    $thumbnail_attributes = borderland_elated_get_attachment_meta_from_url($thumbnail, array('width','height'));
                    ...
                    if (get_post_meta(get_the_ID(), 'eltd_slide-title-background-color', true) !== '') {
                        ...
                        $slide_title_span_style .= 'background-color: ' . esc_attr(borderland_elated_rgba_color($slide_title_bg_color, $slide_title_bg_transparency)) . ';';
                    }
                    ...
                    if (get_post_meta(get_the_ID(), "eltd_slide-separator-title", true) == 'yes') {
                        ...
                        if ($slide_separator_type_var == "without_icon") {
                            ...
                            if ($slide_separator_color !== '') {
                                ...
                                if ($slide_separator_transparency !== '') {
                                    ...
                                    $slide_separator_rgba_color = borderland_elated_rgba_color($slide_separator_color, $slide_separator_transparency);
                        ...
                        if (get_post_meta(get_the_ID(), "eltd_slide_title_separator_type", true) == "with_icon") {
                            ...
                            if (get_post_meta(get_the_ID(), "eltd_slide_title_separator_with_icon_icon_pack", true) != ''){
                                ...
                                $slide_separator_icon_param = $icon_collections->getIconCollection($slide_separator_icon);
                    ...
                    if (get_post_meta(get_the_ID(), 'eltd_slide-subtitle-background-color', true) !== '') {
                        ...
                        $slide_subtitle_span_style .= 'background-color: ' . esc_attr(borderland_elated_rgba_color($slide_subtitle_bg_color, $slide_subtitle_bg_transparency)) . ';';
                    }
                    ...
                    if ($slide_text_separator_var == "no") {
                        ...
                        if (get_post_meta(get_the_ID(), 'eltd_slide-text-background-color', true) !== '') {
                            ...
                            $slide_text_span_style .= 'background-color: ' . esc_attr(borderland_elated_rgba_color($slide_text_bg_color, $slide_text_bg_transparency)) . ';';
                        }
                    ...
                    if ($slide_type == 'video') {
                        ...
                        $html .= '<div class="video"><div class="mobile-video-image" '.borderland_elated_get_inline_style('background-image: url(' . esc_url($video_image) . ')').'></div><div class="video-overlay';
                        ...
                        $html .= '<div class="image" '.borderland_elated_get_inline_style('background-image:url(' . esc_url($image) . ')').'>';
                        if ($slider_thumbs == 'no') {
                            $html .= '<img src="' . esc_url($image) . '" alt="' . esc_attr($title) . '">';
                        }

                        if ($image_overlay_pattern !== "") {
                            $html .= '<div class="image_pattern" '.borderland_elated_get_inline_style('background: url(' . esc_url($image_overlay_pattern) . ') repeat 0 0').'></div>';
                        }
                        $html .= '</div>';
                    }
                    ...
                    if (get_post_meta(get_the_ID(), "eltd_slide-subtitle", true) != "") {
                        ...
                        $html_text .= '<h3 class="eltd_slide_subtitle" '.borderland_elated_get_inline_style($slide_subtitle_style).'><span '.borderland_elated_get_inline_style($slide_subtitle_span_style).'>' . wp_kses_post(get_post_meta(get_the_ID(), 'eltd_slide-subtitle', true)) . '</span></h3>';
                        $html_text .= '</div></div>';
                    }
                    ...
                    if ((get_post_meta(get_the_ID(), "eltd_slide-separator-title", true) == 'yes') && ($slide_separator_position != 'bottom' ) && ($slide_separator_position) != 'left_right') {
                        ...
                        if (get_post_meta(get_the_ID(), 'eltd_slide_title_separator_type', true) !== 'with_icon' && get_post_meta(get_the_ID(), 'eltd_slide_title_separator_type', true) !== 'with_custom_icon') {
                            ...
                            $html_text .= '<div '.borderland_elated_get_inline_style($slide_separator_styles.$slide_top_separator_styles).' class="separator separator_top"></div>';
                            $html_text .= '</div></div>';
                        }
                        else {
                            $html_text .= '<div class="el">';
                    ...
                    if (get_post_meta(get_the_ID(), "eltd_slide-hide-title", true) != true) {
                        ...
                        $html_text .= '<h2 class="eltd_slide_title" '.borderland_elated_get_inline_style($slide_title_style).'>';
                        if ($slide_separator_position == 'left_right') {
                            $html_text .= '<span '.borderland_elated_get_inline_style($slide_separator_styles
                                    .$slide_left_separator_margin).' class="separator separator_left"><span class="slide_separator_dots" '.borderland_elated_get_inline_style($slide_dots_style).'></span></span>';
                        }
                        if (get_post_meta(get_the_ID(), "eltd_slide-title-link", true) != '') {
                            $html_text .= '<a '.borderland_elated_get_inline_style($slide_title_style).' '.$slide_title_data.' href="' . esc_url(get_post_meta(get_the_ID(), "eltd_slide-title-link", true)) . '" target="' . esc_attr(get_post_meta(get_the_ID(), "eltd_slide-title-target", true)) . '">';
                        }
                        $html_text .= '<span '.borderland_elated_get_inline_style($slide_title_span_style).'>' . wp_kses_post(get_the_title()) . '</span>';
                        if (get_post_meta(get_the_ID(), "eltd_slide-title-link", true) != '') {
                            $html_text .= '</a>';
                        }
                        if ($slide_separator_position == 'left_right') {
                            $html_text .= '<span '.borderland_elated_get_inline_style($slide_separator_styles.$slide_right_separator_margin).' class="separator separator_right"><span class="slide_separator_dots" '.borderland_elated_get_inline_style($slide_dots_style).'></span></span>';
                        }
                    ...
                    if ((get_post_meta(get_the_ID(), "eltd_slide-separator-title", true) == 'yes') && ($slide_separator_position != 'top') && ($slide_separator_position) != 'left_right') {
                        ...
                        if (get_post_meta(get_the_ID(), 'eltd_slide_title_separator_type', true) !== 'with_icon' && get_post_meta(get_the_ID(), 'eltd_slide_title_separator_type', true) !== 'with_custom_icon') {
                            ...
                            $html_text .= '<div '.borderland_elated_get_inline_style($slide_separator_styles.$slide_bottom_separator_styles).'  class="separator separator_bottom"></div>';
                            $html_text .= '</div></div>';
                        }
                        else {
                            $html_text .= '<div class="el">';
                    ...
                    if (get_post_meta(get_the_ID(), "eltd_slide-text", true) != "") {
                        ...
                        if ($slide_text_separator_var == 'yes') {
                            ...
                            $html_text .= '<h3 class="eltd_slide_text" '.borderland_elated_get_inline_style($slide_text_style).'><span '.borderland_elated_get_inline_style($slide_text_span_style).'>' . wp_kses_post(get_post_meta(get_the_ID(), "eltd_slide-text", true)) . '</span></h3>';
                        }
                        $html_text .= '</div></div>';
                    }
                    ...
                    if ($is_first_button_shown) {
                        ...
                        if(get_post_meta(get_the_ID(), 'button1_icon_pack', true) !== 'no_icon') {
                            $first_btn_icon_collection = $icon_collections->getIconCollection(get_post_meta(get_the_ID(), 'button1_icon_pack', true));
                        ...
                        $html_text .= '<a class="qbutton '.esc_attr($first_button_icon_class).'" ' . $data_attr1 . ' '.borderland_elated_get_inline_style($button_text_style1).' '.$slide_button_1_data.' href="' . esc_url(get_post_meta(get_the_ID(), "eltd_slide-button-link", true)) . '" target="' . esc_attr($slide_button_target) . '">' . esc_html(get_post_meta(get_the_ID(), "eltd_slide-button-label", true)) .$first_button_icon_html. '</a>';
                    }
                    ...
                    if ($is_second_button_shown) {
                        ...
                        if(get_post_meta(get_the_ID(), 'button2_icon_pack', true) !== 'no_icon') {
                            $second_btn_icon_collection = $icon_collections->getIconCollection(get_post_meta(get_the_ID(), 'button2_icon_pack', true));
                        ...
                        $html_text .= '<a class="qbutton '.esc_attr($second_button_icon_class).'" ' . $data_attr2 . ' '.borderland_elated_get_inline_style($button_text_style2).' '.$slide_button_2_data.' href="' . esc_url(get_post_meta(get_the_ID(), "eltd_slide-button-link2", true)) . '" target="' . esc_attr($slide_button_target2) . '">' . esc_html(get_post_meta(get_the_ID(), "eltd_slide-button-label2", true)) .$second_button_icon_html. '</a>';
                    }
                    ...
                    if ($separate_text_graphic != 'yes') {
                        $html .= '<div class="slider_content ' . esc_attr($content_alignment) .'" '.borderland_elated_get_inline_style($content_width . $content_xaxis . $content_yaxis_start).' '.$slide_data_start.' '.$slide_data_end.'>';
                        $html .= $html_thumb;
                        $html .= $html_text;
                        $html .= '</div>';
                    } else {
                        $html .= '<div class="slider_content graphic_content ' . esc_attr($graphic_alignment) . '" '.borderland_elated_get_inline_style($graphic_width . $graphic_xaxis . $graphic_yaxis_start).'>';
                        $html .= $html_thumb;
                        $html .= '</div>';
                        $html .= '<div class="slider_content ' . esc_attr($content_alignment) . '" '.borderland_elated_get_inline_style($content_width . $content_xaxis . $content_yaxis_start).' '.$slide_data_start.' '.$slide_data_end.'>';
                        $html .= $html_text;
                ...
                $html .= esc_html__('Sorry, no slides matched your criteria.', 'eltd-cpt');
            endif;
            wp_reset_postdata();
            ...
            if ($found_slides > 1) {
                ...
                if ($show_navigation_arrows == "yes") {
                    ...
                    if (borderland_elated_options()->getOptionValue( 'navigation_arrows_type' ) != '') {
                        $icon_navigation_class = borderland_elated_options()->getOptionValue( 'navigation_arrows_type' );
                    }
