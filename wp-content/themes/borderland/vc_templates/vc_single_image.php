...
// backward compatibility
	if ( vc_has_class( 'prettyphoto', $el_class ) || $img_link_target == "open_prettyphoto") {
		$onclick = 'link_image';
	}
...
// backward compatibility
	...
	if($eltd_css_animation != ""){
		$css_class .=  " " . $eltd_css_animation;
	}

	$before_wrapper_start = "";
	$before_wrapper_end = "";
	if($transition_delay != ""){
		$before_wrapper_start = '<div  style="transition-delay:' . $transition_delay . 's">';
...
//to disable relative links uncomment this..
	...
	if ($eltd_css_animation != "") {
		$clsss_css_animation = "  " . $eltd_css_animation;
	} else {
		$clsss_css_animation = "";
	}
	$delay = "";
