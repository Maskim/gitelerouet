...
$html .= '<li class="eltd_circle_outer '.$circle_wrapper_classes.'">';
...
$html .= '<span class="eltd_circle_inner'. $border_class.' " style="'.$circle_wrapper_style.'"><span class="eltd_circle_inner2 '.$image_with_text_class.'" style="'.$circle_style.' '.$image_with_text_style.'">';
