...
add_filter( 'wp_setup_nav_menu_item', 'borderland_elated_add_custom_nav_fields' );

// save menu custom fields
add_action( 'wp_update_nav_menu_item', 'borderland_elated_update_custom_nav_fields', 10, 3 );

// edit menu walker
add_filter( 'wp_edit_nav_menu_walker', 'borderland_elated_edit_walker', 10, 2 );


function borderland_elated_add_custom_nav_fields( $menu_item ) {
 ...
 * @return      void
*/
function borderland_elated_update_custom_nav_fields( $menu_id, $menu_item_db_id, $args ) {
 ...
 * @return      void
*/
function borderland_elated_edit_walker($walker,$menu_id) {
	return 'BorderlandElatedWalkerNavMenuCustom';
	
}

include_once BORDERLAND_ROOT_DIR . '/includes/nav-menu/edit_custom_walker.php';


/* Custom WP_NAV_MENU function for top navigation */

if (!class_exists('BorderlandElatedWalkerNavMenu1')) {
	class BorderlandElatedWalkerNavMenu1 extends Walker_Nav_Menu {
	...
	// add classes to ul sub-menus
		...
		function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if ((($item->current && $depth == 0) ||  ($item->current_item_ancestor && $depth == 0)) && (borderland_elated_options()->getOptionValue( 'page_transitions' ) == "0")):
			...
			if($item->hide == ""){
                ...
                if($depth == 0 && borderland_elated_options()->getOptionValue( 'enable_dropdown_menu_item_icon' ) == "yes" ){
...
if (!class_exists('BorderlandElatedWalkerNavMenu2')) {
	class BorderlandElatedWalkerNavMenu2 extends Walker_Nav_Menu {
...
if (!class_exists('BorderlandElatedWalkerNavMenu3')) {
    class BorderlandElatedWalkerNavMenu3 extends Walker_Nav_Menu {
...
if (!class_exists('BorderlandElatedWalkerNavMenu4')) {
    class BorderlandElatedWalkerNavMenu4 extends Walker_Nav_Menu {
