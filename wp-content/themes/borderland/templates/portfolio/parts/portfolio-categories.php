...
if(borderland_elated_options()->getOptionValue( 'portfolio_hide_categories' )) {
	$portfolio_hide_categories = borderland_elated_options()->getOptionValue( 'portfolio_hide_categories' );
}
...
if(is_array($portfolio_categories) && count($portfolio_categories) && $portfolio_hide_categories != "yes"){
	...
	<div class="info portfolio_single_categories">
		<<?php echo esc_attr($portfolio_info_tag); ?> class="info_section_title" <?php borderland_elated_inline_style($portfolio_info_style); ?>><?php esc_html_e('Category ','borderland'); ?></<?php echo esc_attr($portfolio_info_tag); ?>>
		<p>
			<span class="category">
