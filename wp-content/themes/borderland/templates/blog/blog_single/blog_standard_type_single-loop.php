...
if (borderland_elated_options()->getOptionValue( 'blog_single_show_comments' )) {
    $blog_show_comments = borderland_elated_options()->getOptionValue( 'blog_single_show_comments' );
}
$blog_show_author = "yes";
if (borderland_elated_options()->getOptionValue( 'blog_author_info' )) {
    $blog_show_author = borderland_elated_options()->getOptionValue( 'blog_author_info' );
}
$blog_show_like = "yes";
if (borderland_elated_options()->getOptionValue( 'blog_single_show_like' )) {
    $blog_show_like = borderland_elated_options()->getOptionValue( 'blog_single_show_like' );
}
$blog_show_date = "yes";
if (borderland_elated_options()->getOptionValue( 'blog_single_show_date' )) {
    $blog_show_date = borderland_elated_options()->getOptionValue( 'blog_single_show_date' );
}

$blog_social_share_type = "dropdown";
if(borderland_elated_options()->getOptionValue( 'blog_single_select_share_option' )){
	$blog_social_share_type = borderland_elated_options()->getOptionValue( 'blog_single_select_share_option' );
}
...
if (borderland_elated_options()->getOptionValue( 'enable_social_share' ) =="yes"){
    if (borderland_elated_options()->getOptionValue( 'post_types_names_post' ) =="post"){
        if (borderland_elated_options()->getOptionValue( 'blog_single_show_social_share' )) {
            $blog_show_social_share = borderland_elated_options()->getOptionValue( 'blog_single_show_social_share' );
        }
    }
}
$blog_show_categories = "yes";
if (borderland_elated_options()->getOptionValue( 'blog_single_show_category' )) {
    $blog_show_categories = borderland_elated_options()->getOptionValue( 'blog_single_show_category' );
}
$blog_show_ql_icon = "yes";
$blog_title_holder_icon_class = "";
if (borderland_elated_options()->getOptionValue( 'blog_single_show_ql_icon' )) {
    $blog_show_ql_icon = borderland_elated_options()->getOptionValue( 'blog_single_show_ql_icon' );
}
			...
			<div class="post_content_holder">
                 ...
                 <div class="post_text">
                    <div class="post_text_inner">
						...
						<?php } ?>
						<?php if(borderland_elated_options()->getOptionValue( 'blog_single_show_social_share' ) == "yes" && $blog_social_share_type == "list") {
		...
		<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
            <div class="post_content_holder">
                <div class="post_text_columns">
					<div class="post_text<?php echo esc_attr($background_image_html_class); ?>" <?php borderland_elated_inline_style($background_image_html); ?>>
						<div class="post_text_inner">
