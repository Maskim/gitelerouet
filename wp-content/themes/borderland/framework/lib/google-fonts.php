...
if ( ! function_exists( 'borderland_elated_init_google_fonts_array' ) ) {
	function borderland_elated_init_google_fonts_array() {
...
';
		...
		$borderland_fonts_array = $google_fonts_decoded['items'];
	}
	
	add_action('after_setup_theme', 'borderland_elated_init_google_fonts_array');
}