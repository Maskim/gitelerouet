...
$eltd_custom_sidebars = borderland_elated_get_custom_sidebars();
...
$eltd_hide_featured_image = new BorderlandElatedMetaField(
	"yesno",
	"eltd_hide-featured-image",
	"no",
	esc_html__( "Hide Feature image", 'borderland' ),
	esc_html__( "Do you want to hide feature image for this post?", 'borderland' )
);
$eltdGeneral->addChild(
	"eltd_hide-featured-image",
	$eltd_hide_featured_image
);
...
$eltd_show_page_title = new BorderlandElatedMetaField(
	...
	array(
		"dependence" => true,
		"hide"       => array(
			"no" => "#eltdf_eltd_page_title_area_container, #eltdf-meta-box-post_title_animations"
		),
		"show"       => array(
			""    => "#eltdf_eltd_page_title_area_container, #eltdf-meta-box-post_title_animations",
			"yes" => "#eltdf_eltd_page_title_area_container, #eltdf-meta-box-post_title_animations"
		)
	)
);
$eltdTitle->addChild(
...
$eltd_subtitle_like_separator = new BorderlandElatedMetaField(
	...
	array(
		...
		"show"       => array( "yes" => "#eltdf_eltd_subtitle_like_separator_container" )
	)
);
$eltd_title_standard_container->addChild(
	"eltd_subtitle_like_separator",
...
$subtitle_padding_group = new BorderlandElatedGroup(
	esc_html__( "Padding", 'borderland' ),
	esc_html__( "Define padding for subtitle (When using separator around subtitle, only right margin is counted for left/right margin)", 'borderland' )
);
$eltd_page_title_area_container->addChild(
...
$eltdLinkPostFormat = new BorderlandElatedMetaBox(
	"post",
	esc_html__( "Link Post Format", 'borderland' )
);
$borderland_elated_framework->eltdMetaBoxes->addMetaBox(
	"post-format-link",
	$eltdLinkPostFormat
...
$title_link = new BorderlandElatedMetaField(
	...
	esc_html__( "Enter link", 'borderland' )
);
$eltdLinkPostFormat->addChild(
	"title_link",
	$title_link
);
...
$eltdQuotePostFormat = new BorderlandElatedMetaBox(
	"post",
	esc_html__( "Quote Post Format", 'borderland' )
);
$borderland_elated_framework->eltdMetaBoxes->addMetaBox(
	"post-format-quote",
	$eltdQuotePostFormat
...
$quote_format = new BorderlandElatedMetaField(
	"text",
	"quote_format",
	"",
	esc_html__( "Quote", 'borderland' ),
	esc_html__( "Enter Quote", 'borderland' )
);
$eltdQuotePostFormat->addChild(
	"quote_format",
	$quote_format
);
...
$eltdAudioPostFormat = new BorderlandElatedMetaBox(
	"post",
	esc_html__( "Audio Post Format", 'borderland' )
);
$borderland_elated_framework->eltdMetaBoxes->addMetaBox(
	"post-format-audio",
	$eltdAudioPostFormat
...
$audio_link = new BorderlandElatedMetaField(
	"text",
	"audio_link",
	"",
	esc_html__( "Link", 'borderland' ),
	esc_html__( "Enter audion link", 'borderland' )
);
$eltdAudioPostFormat->addChild(
	"audio_link",
	$audio_link
);
...
$eltdVideoPostFormat = new BorderlandElatedMetaBox(
	"post",
	esc_html__( "Video Post Format", 'borderland' )
);
$borderland_elated_framework->eltdMetaBoxes->addMetaBox(
	"post-format-video",
	$eltdVideoPostFormat
...
$video_format_choose = new BorderlandElatedMetaField(
	"select",
	"video_format_choose",
	"youtube",
	esc_html__( "Video Type", 'borderland' ),
	esc_html__( "Choose video type", 'borderland' ),
	array(
		"youtube" => esc_html__( "Youtube", 'borderland' ),
		"vimeo" => esc_html__( "Vimeo", 'borderland' ),
		"self" => esc_html__( "Self Hosted", 'borderland' )
	),
	array(
		"dependence" => true,
		"hide"       => array(
			"youtube" => "#eltdf_video_self_hosted_container",
			"vimeo"   => "#eltdf_video_self_hosted_container",
			"self"    => "#eltdf_video_y_and_v_container"
		),
		"show"       => array(
			"youtube" => "#eltdf_video_y_and_v_container",
			"vimeo"   => "#eltdf_video_y_and_v_container",
			"self"    => "#eltdf_video_self_hosted_container"
		)
	)
);
$eltdVideoPostFormat->addChild(
	"video_format_choose",
	$video_format_choose
);

$video_y_and_v_container = new BorderlandElatedContainer(
...
$video_self_hosted_container = new BorderlandElatedContainer(
...
$video_format_link = new BorderlandElatedMetaField(
	"text",
	"video_format_link",
	"",
	esc_html__( "Video ID", 'borderland' ),
	esc_html__( "Enter Video ID", 'borderland' )
);
...
$video_format_image = new BorderlandElatedMetaField(
	"image",
	"video_format_image",
	"",
	esc_html__( "Video Image", 'borderland' ),
	esc_html__( "Upload video image", 'borderland' )
);
...
$video_format_webm = new BorderlandElatedMetaField(
	"text",
	"video_format_webm",
	"",
	esc_html__( "Video webm", 'borderland' ),
	esc_html__( "Enter video URL", 'borderland' )
);
$video_self_hosted_container->addChild(
	"video_format_webm",
	$video_format_webm
...
$video_format_mp4 = new BorderlandElatedMetaField(
	"text",
	"video_format_mp4",
	"",
...
$video_format_ogv = new BorderlandElatedMetaField(
	"text",
	"video_format_ogv",
	"",
