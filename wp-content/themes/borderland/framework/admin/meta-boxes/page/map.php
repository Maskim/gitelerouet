...
$eltd_enable_content_top_margin = new BorderlandElatedMetaField(
	"yesnosimple",
	"eltd_enable_content_top_margin",
	"no",
	esc_html__( "Always put content below header", 'borderland' ),
	esc_html__( "Enabling this option always will put content below header ", 'borderland' )
);
$row1->addChild(
	"eltd_enable_content_top_margin",
	$eltd_enable_content_top_margin
...
$eltd_page_vertical_area_transparency = new BorderlandElatedMetaField(
	...
	esc_html__( "Enabling this option will make Side Menu background transparent ", 'borderland' ),
	array(
		"no" => esc_html__( "No", 'borderland' ),
		"yes" => esc_html__( "Yes", 'borderland' )
	)
...
$eltd_page_vertical_area_background = new BorderlandElatedMetaField(
	...
	esc_html__( "Choose a color for Side Menu background", 'borderland' )
);
$eltdLeftMenuArea->addChild(
	"eltd_page_vertical_area_background",
	$eltd_page_vertical_area_background
...
$eltdBlog = new BorderlandElatedMetaBox(
	"page",
...
$eltd_choose_blog_category = new BorderlandElatedMetaField(
	"selectblank",
	"eltd_choose-blog-category",
	"",
	esc_html__( "Blog Category", 'borderland' ),
	esc_html__( "Choose category of posts to display (leave empty to display all categories)", 'borderland' ),
	$eltd_blog_categories
);
$eltdBlog->addChild(
	"eltd_choose-blog-category",
	$eltd_choose_blog_category
);

$eltd_show_posts_per_page = new BorderlandElatedMetaField(
	"text",
	"eltd_show-posts-per-page",
	"",
	esc_html__( "Number of Posts", 'borderland' ),
	esc_html__( "Enter the number of posts to display", 'borderland' ),
	array(),
	array( "col_width" => 3 )
);
$eltdBlog->addChild(
	"eltd_show-posts-per-page",
	$eltd_show_posts_per_page
);

$eltd_enable_page_comments = new BorderlandElatedMetaField(
	"yesno",
	"eltd_enable-page-comments",
	"no",
	esc_html__( "Show Comments", 'borderland' ),
	esc_html__( "Enabling this option will show comments on your page ", 'borderland' )
);
$eltdBlog->addChild(
	"eltd_enable-page-comments",
	$eltd_enable_page_comments
);
