<div class="eltdf-tabs-navigation-wrapper">
    <ul class="nav nav-tabs">
        <?php
        foreach (borderland_elated_options()->adminPages as $key => $page ) {
            $slug = "";
        ...
        ?>
        <li <?php if($is_import_page) { echo "class='active'"; } ?>><a href="<?php echo esc_url(get_admin_url().'admin.php?page=eltd_theme_menu_tabimport'); ?>"><i class="fa fa-download eltdf-tooltip eltdf-inline-tooltip left" data-placement="top" data-toggle="tooltip" title="<?php esc_attr_e( 'Import', 'borderland' ); ?>"></i><span><?php esc_html_e( 'Import', 'borderland' ); ?></span></a></li>
    </ul>
